export const zhCN = {
  ...
  'section.stockEmpty': '暂无股票，在上方输入框添加（如 600519）',
  'section.fundEmpty': '暂无场内基金，在上方输入框添加（如 510500）',
  'empty.dualPool': '添加股票（最多 5）或场内基金（最多 5）开始监控',
  ...
  'widget.pinEmpty': '请在完整看板钉选 1–4 只证券',
  ...
  'toast.stockLimit': '股票已达上限 5 只',
  'toast.fundLimit': '基金已达上限 5 只',
